...
const ctrl     = require('../../controllers/admin/frameController');
const validate = require('../../middleware/validate');
const v        = require('../../validators/admin/frame');
const { createUploader, ALLOWED_IMAGE_TYPES } = require('../../middleware/uploadS3');
const { S3_FOLDERS } = require('../../utils/constants');

const upload = createUploader(S3_FOLDERS.FRAMES, ALLOWED_IMAGE_TYPES).single('image');
