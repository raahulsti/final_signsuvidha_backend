...
const ctrl     = require('../../controllers/admin/elementController');
const validate = require('../../middleware/validate');
const v        = require('../../validators/admin/element');
const { createUploader, ALLOWED_IMAGE_TYPES } = require('../../middleware/uploadS3');
const { S3_FOLDERS } = require('../../utils/constants');

const upload = createUploader(S3_FOLDERS.ELEMENTS, ALLOWED_IMAGE_TYPES).single('image');
