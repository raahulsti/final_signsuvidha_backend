...
const ctrl = require('../../controllers/admin/illuminationOptionController');
const validate = require('../../middleware/validate');
const v = require('../../validators/admin/illuminationOption');
const { createUploader, ALLOWED_IMAGE_TYPES } = require('../../middleware/uploadS3');
const { S3_FOLDERS } = require('../../utils/constants');

const upload = createUploader(S3_FOLDERS.ILLUMINATION, ALLOWED_IMAGE_TYPES).single('image');
