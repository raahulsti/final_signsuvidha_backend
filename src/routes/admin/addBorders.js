...
const ctrl     = require('../../controllers/admin/addBorderController');
const validate = require('../../middleware/validate');
const v        = require('../../validators/admin/addBorder');
const { createUploader, ALLOWED_IMAGE_TYPES } = require('../../middleware/uploadS3');
const { S3_FOLDERS } = require('../../utils/constants');

const upload = createUploader(S3_FOLDERS.ADD_BORDERS, ALLOWED_IMAGE_TYPES).single('image');
