...
const createItem = (conn, item) => {
  const {
    ...
    area_sqft, base_area_sqft, text_area_sqft, logo_area_sqft,
  ...
  const values = [
    ...
    area_sqft ?? null, base_area_sqft ?? null, text_area_sqft ?? null, logo_area_sqft ?? null,
